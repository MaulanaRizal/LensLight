...
@section('content')
            ...
            <div class="breadcrumb-area" style="background: rgba(0, 0, 0, 0) url({{asset('accessories.jpg')}}) no-repeat scroll center top; background-size:cover">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="breadcrumb-list">
							...
							<ul>
								...
								<li><a href="{{route('accessories')}}">Accessories</a> <span class="divider">|</span></li>
