    ...
    <body>
					...
					<div class="inner-container">
						<div class="row">
							<div class="col-md-2 col-sm-4 col-xs-5">
								<div class="logo">
									<a href="index.html"><img src="{{asset('pabna/img/logo-white-text.png')}}" alt="" /></a>
								</div>
							</div>
							<div class="col-md-8 hidden-xs hidden-sm">
								<div class="main-menu">
									<nav>
										<ul>
											<li class="static"><a href="{{route('home')}}">Home</a>
												<div class="mega-menu">
													<div class="mega-left">
														<span>
													...
													<div class="mega-right">
														<span class="mega-menu-img">
															<a href="shop.html"><img alt="" src="{{asset('pabna/img/1.jpg')}}"></a>
														</span>
													</div>
												</div>
											</li>
											<li><a href="shop.html">Categorias</a>
		...
		<div class="slider-area">
			<div class="slider-active">
				<div class="single-slider slide-height d-flex align-items-center" style="background-image:url({{asset('pabna/img/slider/slide2.jpg')}})">
					<div class="container">
						<div class="row">
				...
				<div class="single-slider slide-height d-flex align-items-center" style="background-image:url({{asset('pabna/img/slider/slide3.jpg')}})">
					<div class="container">
						<div class="row">
							<div class="col-xl-10 offset-xl-1">
								<div class="slide-content text-center">
