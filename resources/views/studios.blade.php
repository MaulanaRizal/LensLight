										...
										<div class="col-md-12">
											<div class="single-product">
												<div class="product-img">
													<a href="{{route('studioDetail',['id' => 0])}}">
												...
												<div class="product-content">
													<h3><a href="{{route('studioDetail',['id' => 0])}}">Lorem ipsum dolor</a></h3>
													<div class="price">
														<span>$80.00</span>
						...
						<div class="brand-curosel">
							<div class="col-md-12">
								<div class="single-brand">
									<a href="#"><img src="{{asset('pabna/img/brand/1.png')}}" alt="" /></a>
								</div>
							</div>
							<div class="col-md-12">
								<div class="single-brand">
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="payment-img">
								<img src="{{asset('pabna/img/payment.png')}}" alt="" />
							</div>
						</div>
					</div>
				</div>
